...
class ExpandableZoomControl extends StatefulWidget {
  const ExpandableZoomControl({super.key, required this.state});

  final CameraState state;

  @override
  State<ExpandableZoomControl> createState() => _ExpandableZoomControlState();
}

class _ExpandableZoomControlState extends State<ExpandableZoomControl> {
        ...
        builder: (_, snapshot) {
          ...
          return SizedBox(
            ...
            child: ListView.builder(
              ...
              itemCount: isExpanded ? zoomList.length : 1,
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: () {
                    if (!isExpanded) {
                      // Expand to show all zoom options
                      setState(() {
                        isExpanded = true;
                      });
                    } else {
